...
COMMENT ON TABLE user_ad_account_permissions IS 'Armazena as permissões de acesso de usuários às contas de anúncio do Meta Ads';
COMMENT ON TABLE user_ga_property_permissions IS 'Armazena as permissões de acesso de usuários às propriedades do Google Analytics';
